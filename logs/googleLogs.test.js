...
describe('GoogleLogs', () => {
  ...
  describe('#constructor()', () => {
    ...
    describe('hooks', () => {
      ...
      it('should run "before:logs:logs" promise chain', () => googleLogs.hooks['before:logs:logs']().then(() => {
        expect(validateStub.calledOnce).toEqual(true);
        expect(setDefaultsStub.calledAfter(validateStub)).toEqual(true);
      }));

      it('should run "logs:logs" promise chain', () => googleLogs.hooks['logs:logs']().then(() => {
