...
describe('GoogleRemove', () => {
  ...
  describe('#constructor()', () => {
    ...
    describe('hooks', () => {
      ...
      it('should run "before:remove:remove" promise chain', () => googleRemove.hooks['before:remove:remove']().then(() => {
      ...
      it('should run "remove:remove" promise chain', () => googleRemove.hooks['remove:remove']().then(() => {
