...
describe('GoogleInvoke', () => {
  ...
  describe('#constructor()', () => {
    ...
    describe('hooks', () => {
      ...
      it('should run "before:invoke:invoke" promise chain', () => googleInvoke.hooks['before:invoke:invoke']().then(() => {
        expect(validateStub.calledOnce).toEqual(true);
        expect(setDefaultsStub.calledAfter(validateStub)).toEqual(true);
      }));

      it('should run "invoke:invoke" promise chain', () => googleInvoke.hooks['invoke:invoke']().then(() => {
